...
const sessdata = config.SESSION_ID.replace("GOLDEN_MD~", '');
...
console.log("Connecting GOLDEN-MD 🧬...");
...
console.log('GOLDEN-MD Is Installing ⬆️... ')
const path = require('path');
...
console.log('GOLDEN-MD connected to whatsapp ✅')
